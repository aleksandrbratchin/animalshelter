package ru.teamfour.textcommand.handler.impl.volunteer.handlerbutton.clientchat;
...
@Component
public class EndChatClientHandler extends AbstractHandler {
    public EndChatClientHandler(@Qualifier("endChatClientCommand") Command command) {
