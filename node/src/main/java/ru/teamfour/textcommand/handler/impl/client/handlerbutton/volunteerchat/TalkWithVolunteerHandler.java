package ru.teamfour.textcommand.handler.impl.client.handlerbutton.volunteerchat;
...
@Component
public class TalkWithVolunteerHandler extends AbstractHandler {
    public TalkWithVolunteerHandler(@Qualifier("talkWithVolunteerCommand") Command command) {
