package ru.teamfour.textcommand.handler.impl.volunteer.handlerbutton.checkreport;
...
@Component
public class AcceptReportHandler extends AbstractHandler {
    public AcceptReportHandler(@Qualifier("acceptReportCommand") Command command) {
