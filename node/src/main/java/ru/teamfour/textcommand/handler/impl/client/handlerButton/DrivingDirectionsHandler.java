...
@Component
public class DrivingDirectionsHandler extends AbstractHandler {
    public DrivingDirectionsHandler(@Qualifier("drivingDirectionsCommand") TextCommand textCommand) {
