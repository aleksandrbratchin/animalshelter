...
@Component
public class HomeImprovementForYoungAnimalHandler extends AbstractHandler {
    public HomeImprovementForYoungAnimalHandler(@Qualifier("homeImprovementForYoungAnimalCommand") Command command) {
