...
@Component
public class ContactVolunteersByPhoneNumberHandler extends AbstractHandler {
    public ContactVolunteersByPhoneNumberHandler(@Qualifier("contactVolunteersByPhoneNumberCommand") TextCommand textCommand) {
