...
@Component
public class HomeImprovementForAdultAnimalHandler extends AbstractHandler {
    public HomeImprovementForAdultAnimalHandler(@Qualifier("homeImprovementForAdultAnimalCommand") Command command) {
