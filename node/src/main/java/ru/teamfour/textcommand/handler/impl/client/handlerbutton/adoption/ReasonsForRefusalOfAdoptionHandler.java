...
@Component
public class ReasonsForRefusalOfAdoptionHandler extends AbstractHandler {
    public ReasonsForRefusalOfAdoptionHandler(@Qualifier("reasonsForRefusalOfAdoptionCommand") Command command) {
