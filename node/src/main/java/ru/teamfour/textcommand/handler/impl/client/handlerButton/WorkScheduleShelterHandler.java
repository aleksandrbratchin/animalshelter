...
@Component
public class WorkScheduleShelterHandler extends AbstractHandler {
    public WorkScheduleShelterHandler(@Qualifier("workScheduleShelterCommand") TextCommand textCommand) {
