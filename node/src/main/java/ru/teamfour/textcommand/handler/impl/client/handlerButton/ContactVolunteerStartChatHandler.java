...
@Component
public class ContactVolunteerStartChatHandler extends AbstractHandler {
    public ContactVolunteerStartChatHandler(@Qualifier("contactVolunteerStartChatCommand") TextCommand textCommand) {
