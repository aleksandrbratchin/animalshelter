package ru.teamfour.textcommand.handler.impl.client.handlerbutton.mainmenu;
...
public class ShelterInformationHandler extends AbstractHandler {
    public ShelterInformationHandler(@Qualifier("shelterInformationCommand") Command command) {
