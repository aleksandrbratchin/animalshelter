...
@Component
public class StoryOfShelterCommand extends AbstractCommand {
    ...
    public MessageToTelegram execute(CommandContext commandContext) {
        ...
        String aboutShelter = user.getShelter().getAboutShelter();
        String answerMessage = "Нет информации";
        if (aboutShelter != null) {
            answerMessage = "Рассказ о приюте: \n" + aboutShelter;
        }
