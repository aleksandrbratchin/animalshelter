...
ALTER TABLE public.users
    ADD CONSTRAINT fkkjrm7r3emrq99t5en9sjdsg5u FOREIGN KEY (shelter_id) REFERENCES public.shelters (id);
...
ALTER TABLE public.adoption_process_animal
    ADD CONSTRAINT fkcv8k8pjj6rhqgq13kjaotje71 FOREIGN KEY (animal_id) REFERENCES public.animals (id);
ALTER TABLE public.adoption_process_animal
    ADD CONSTRAINT fkfmccis708ahki042x3yfrgc1s FOREIGN KEY (shelter_id) REFERENCES public.shelters (id);
ALTER TABLE public.adoption_process_animal
    ADD CONSTRAINT fkq36alfrt46anaxkmal9pmqwtu FOREIGN KEY (user_id) REFERENCES public.users (id);
...
ALTER TABLE public.animals
    ADD CONSTRAINT fk7fmlpw3o4ourhtv3qy8gl6cn5 FOREIGN KEY (shelter_id) REFERENCES public.shelters (id);
...
ALTER TABLE public.daily_report
    ADD CONSTRAINT fkd2rwr80f6v6w1tuil9u2a2lox FOREIGN KEY (adoption_animal_id) REFERENCES public.adoption_process_animal (id);
ALTER TABLE public.daily_report
    ADD CONSTRAINT fkeutnc4tinni81h3a4nuv3op5v FOREIGN KEY (volunteer_id) REFERENCES public.users (id);
ALTER TABLE public.daily_report
    ADD CONSTRAINT fkh5mc7nxb2eysi53u3wv90gmq0 FOREIGN KEY (photo_report_id) REFERENCES public.photo_report (id);
...
ALTER TABLE public.driving_directions
    ADD CONSTRAINT fkjopdd4vy6v7o2djebw0qwlgw5 FOREIGN KEY (shelter_id) REFERENCES public.shelters (id);
